...
const handleNext = () =>{
  ...
  return (
   <div className='py-14 min-h-[cale(100vh-100px)]:'>
    <Stepper activeStep={activeStep}>
        ...
        <div className='flex justify-between items-center px-4 fixed z-24 bottom-0 bg-white left-0 w-full py-4 border-slate-200'
